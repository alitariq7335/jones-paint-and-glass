...
type DiySliderBlockProps = {
  ...
  showTiktok?: boolean;
  darkBackground?: boolean; // ← single toggle controls everything
  slides?: DiyItem[];
};
...
export default function Diyslider({
  ...
  // ── Theme values based on darkBackground toggle ──
  ...
  return (
    <section
      className={`relative w-full  ${sectionBg} py-6 sm:py-12 md:py-14`}
    >
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto flex flex-col md:flex-row md:items-end justify-between text-center md:text-start gap-6 mb-15 px-4 sm:px-6 md:px-12">
          <div className="w-full xl:w-1/2 lg:w-2/3 md:w-2/3">
            <h2
              className={`text-[28px] md:text-[34px] lg:text-[48px] font-bold ${headingColor} mb-3 leading-tight font-['Avenir']`}
            >
              {heading}
            </h2>
            <p
              className={`text-[16px] ${subtextColor} leading-relaxed mb-6 pr-0 md:pr-[15%] font-['Avenir']`}
            >
              {subtext}
            </p>
            ...
            {slides && slides.length > 0 ? (
              ...
              <div className="flex items-center justify-center h-[300px]">
                <p className="text-gray-400">
                  No slides added. Create slides in Payload admin.
                </p>
              </div>
            )}
          </div>
