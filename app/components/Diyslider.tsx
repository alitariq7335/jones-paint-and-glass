...
const locations = [
  { id: 1, name: 'St George', img: '/assets/jt/diy-1.png' },
  { id: 2, name: 'American Fork', img: '/assets/jt/diy-2.png' },
  { id: 3, name: 'Payson', img: '/assets/jt/diy-3.png' },
  { id: 4, name: 'American Fork', img: '/assets/jt/diy-4.png' },
  { id: 5, name: 'Payson', img: '/assets/jt/diy-5.png' },
  { id: 6, name: 'American Fork', img: '/assets/jt/diy-4.png' },
...
export default function Diyslider() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-b from-[#002559] to-[#0052C6] py-10 sm:py-12 md:py-14">
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto flex flex-col md:flex-row md:items-end justify-between text-center md:text-start gap-6 mb-15 px-4 sm:px-6 md:px-12">
          ...
          <div className="w-full xl:w-1/2 lg:w-2/3 md:w-2/3">
            <h2 className="text-[28px] md:text-[34px] lg:text-[48px] font-bold text-white mb-3 leading-tight font-['Avenir']">
              Get More DIY Tips &amp; Ideas
            </h2>
            <p className="text-[16px] text-white leading-relaxed mb-6 pr-0 md:pr-[15%] font-['Avenir']">
              Follow us on social media for how-to videos and product info from
              the same pros who will help you in our stores.
            </p>
            ...
            <div className="flex gap-3 mt-4 justify-center md:justify-start">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-md border text-sm font-semibold transition-all duration-200 cursor-pointer ${activeTab === "instagram"
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-md border text-sm font-semibold transition-all duration-200 cursor-pointer ${activeTab === "tiktok"
                  ? "bg-white text-[#0052C6] border-white"
                  : "bg-white text-[#0052C6] border-white/40 hover:border-white/80"
                  }`}
              >
                <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
