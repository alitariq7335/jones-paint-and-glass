        ...
        <section className="container mx-auto py-16">
            <div className="px-4 lg:px-6 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                ...
                <div className="flex w-full lg:w-auto items-center gap-4">
                    ...
                    {/* Button */}
                    <button className="group inline-flex border-2 border-[#0052C6] cursor-pointer text-[#0052C6] font-semibold text-[16px] gap-[2px] px-4 py-2 rounded-[8px] items-center transition-colors whitespace-nowrap">
                        Go
                        <svg
