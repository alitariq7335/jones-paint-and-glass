            ...
            >
                ...
                <div className="flex gap-3 mb-4">
                    <div className="flex-1">
                        <label className="block text-white text-[16px] tracking-wide font-extralight mb-2">First name</label>
                        <input
                            type="text"
                            placeholder="First name"
                            className="w-full bg-white rounded-[8px] px-3 py-3 text-sm text-gray-800 placeholder-gray-800 outline-none focus:ring-0 focus:ring-blue-300"
                        />
                    </div>
                    <div className="flex-1">
                        <label className="block text-white text-[16px] tracking-wide font-medium mb-2">Last name</label>
                        <input
                            type="text"
                ...
                {/* Email */}
                <div className="mb-4">
                    <label className="block text-white text-[16px] tracking-wide font-medium mb-2">Email</label>
                    <input
                        type="email"
                ...
                {/* Phone */}
                <div className="mb-4">
                    <label className="block text-white text-[16px] tracking-wide font-medium mb-2">Phone number (optional)</label>
                    <div className="flex gap-2">
                        <select
                            value={country}
                            onChange={(e) => setCountry(e.target.value)}
                            className="bg-white rounded-[8px] px-2 py-3 text-sm text-gray-800 outline-none focus:ring-2 focus:ring-blue-300 w-20"
                        >
                        ...
                        <input
                            ...
                            className="flex-1 bg-white rounded-[8px] px-3 py-3 text-sm text-gray-800 placeholder-gray-800 outline-none focus:ring-0 focus:ring-blue-300"
                        />
                    </div>
                </div>
                ...
                {/* Location / Store */}
                <div className="mb-4">
                    <label className="block text-white text-[16px] tracking-wide font-medium mb-2">Where are you located?</label>
                    <select className="w-full bg-white rounded-[8px] px-3 py-3 text-sm text-gray-800 outline-none focus:ring-0 focus:ring-blue-300 appearance-none">
                ...
                {/* Message */}
                <div className="mb-5">
                    <label className="block text-white text-[16px] tracking-wide font-medium mb-2">Message</label>
                    <textarea
                        rows={4}
                        className="w-full bg-white rounded-[8px] px-3 py-3 text-sm text-gray-800 placeholder-gray-800 outline-none focus:ring-0 focus:ring-blue-300 resize-none"
                    />
                </div>
